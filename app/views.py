...
def home(request):
  ...
  context={'topwear':topwears,'mobile':mobile,'laptop':laptop}
...
#  elif data =='difference':
#   mobiles = Product.objects.filter(category='M').filter(discounted_price=(10000,20000))
 elif data =='above':
...
class CustomerRegistrationView(View):
  ...
  def post(self,request):
    ...
    if form.is_valid():
      messages.success(request,'Congratulation for successfully register')
      form.save()
    return render(request, 'app/customerregistration.html',{'form':form})
...
class ProfileView(View):
  ...
  def post(self,request):
      ...
      if form.is_valid():
        ...
        reg.save()
        messages.success(request,'Congratulation Your Profile is Updated Successfully !!')
